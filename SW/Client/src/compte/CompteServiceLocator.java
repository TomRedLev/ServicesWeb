...
public class CompteServiceLocator extends org.apache.axis.client.Service implements compte.CompteService {
    ...
    private java.lang.String Compte_address = "http://localhost:8080/Banque/services/Compte";
    ...
    public compte.Compte getCompte() throws javax.xml.rpc.ServiceException {
    ...
    public compte.Compte getCompte(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            compte.CompteSoapBindingStub _stub = new compte.CompteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (compte.Compte.class.isAssignableFrom(serviceEndpointInterface)) {
                compte.CompteSoapBindingStub _stub = new compte.CompteSoapBindingStub(new java.net.URL(Compte_address), this);
                _stub.setPortName(getCompteWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://compte", "CompteService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://compte", "Compte"));
        }
